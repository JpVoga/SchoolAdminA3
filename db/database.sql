...
CREATE TABLE grade(
    ...
    CONSTRAINT grade_student_fk FOREIGN KEY(student_id) REFERENCES student(id) ON DELETE CASCADE,
    CONSTRAINT grade_test_fk FOREIGN KEY(test_id) REFERENCES test(id) ON DELETE CASCADE
);
